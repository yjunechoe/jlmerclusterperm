...
- Existing implementations of CPA in R ([permuco](https://jaromilfrossard.github.io/permuco/), [permutes](https://cran.r-project.org/web/packages/permutes), etc.) whose designs inspired the CPA interface in jlmerclusterperm.
