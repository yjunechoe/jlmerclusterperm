...
1) [Garrison et al. 2020](https://yjunechoe.github.io/jlmerclusterperm/articles/Garrison-et-al-2020.html), which introduces the package's functions for running a CPA, demonstrating both wholesale and piecemeal approachrs. It also compares the use of linear vs. logistic regression for the calculation of timewise statistics.
