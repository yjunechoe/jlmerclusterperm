...
# Results of the first CPA of the session (with counter = 0) is the same
get_rng_state()
identical(
  CPA_1_0,
  clusterpermute(jlmer_spec, threshold = 1, nsim = 100, progress = FALSE)
...
Given the interface to the RNG counter, there are not many unique advantages to using a different seed over manipulating the RNG counter.
